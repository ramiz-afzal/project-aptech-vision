            ...
            <div class="col-12 col-lg-9 pr-3 pr-lg-2">
                ...
                <?php for($i=0;$i <= 10; $i++):?>
                    <div class="card main-card my-2 mb-4">
                        <div class="card-body">
                            <a href="#" class="text-decoration-none main-color-font">
                                <h5 class="card-title">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eligendi, corporis.</h5>
                            </a>
                            ...
                            <div class="card-body p-1">
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-4 col-md-4 col-lg-2 d-flex justify-content-center align-items-center">
                            ...
                            <div class="p-sm-1 p-lg-0 col-12 col-md-6 col-lg-12 ">
                                <div class="border rounded my-1 p-0">
                                    <div class="d-flex p-1">
                                        <div style="width: 52px; height:52px;" class="main-color rounded-lg p-2">
                                            <a href="#">
                                                <img src="./source/media/category icons/Pain.png" alt="category-image" class="img-fluid">
                                            </a>
                                        </div>
                                ...
                                <div class="border rounded my-1 p-1 main-color-light">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex flex-row align-items-center">
                                            <div style="width: 32px; height:32px; overflow:hidden;" class="bg-light rounded-lg d-flex justify-content-center align-items-center m-1">
                                                <a href="#"><img class="img-fluid" src="./source/media/category icons/profile.jpg" alt=""></a>
                                            </div>
                                            <a href="#" class="text-decoration-none main-color-font">
                                                <span class="card-title m-0 font-weight-bold">John Doe</span>
                                            </a>
                                        </div>
                                        <div class="d-flex flex-row justify-content-around justify-content-lg-between px-1">
                                            <span>
